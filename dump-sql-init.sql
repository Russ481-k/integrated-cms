...
INSERT INTO `bbs_category` VALUES (4,1,'NOTICE','공지',1,'Y',NULL,NULL,'2025-07-16 05:09:54',NULL,NULL,'2025-07-16 05:09:54'),(5,1,'PROMOTION','홍보',2,'Y',NULL,NULL,'2025-07-16 05:09:54',NULL,NULL,'2025-07-16 05:09:54'),(6,1,'EXTERNAL_PROMOTION','유관기관 홍보',3,'Y',NULL,NULL,'2025-07-16 05:09:54',NULL,NULL,'2025-07-16 05:09:54');
...
INSERT INTO `bbs_master` VALUES (1,'공지사항','BASIC','USER','ADMIN','ADMIN','Y','D','Y','Y','Y',4,10,NULL,NULL,'2025-05-03 06:18:30',NULL,NULL,'2025-07-18 09:27:26'),(2,'자주 묻는 질문','FAQ','USER','ADMIN','ADMIN','Y','D','Y','Y','N',0,0,NULL,NULL,'2025-05-03 06:18:30',NULL,NULL,'2025-06-13 05:31:21'),(3,'고객의 소리','QNA','USER','USER','ADMIN','N','D','Y','Y','Y',3,5,NULL,NULL,'2025-05-03 06:18:30',NULL,NULL,'2025-07-21 01:46:13'),(4,'보도자료','PRESS','USER','ADMIN','ADMIN','Y','D','Y','Y','Y',5,10,NULL,NULL,'2025-05-03 06:18:30',NULL,NULL,'2025-06-13 05:31:21'),(5,'자료실','FORM','USER','ADMIN','ADMIN','Y','D','Y','Y','Y',10,20,NULL,NULL,'2025-05-03 06:18:30',NULL,NULL,'2025-06-13 05:31:21'),(6,'갤러리','BASIC','USER','ADMIN','ADMIN','Y','D','Y','Y','Y',10,50,NULL,NULL,'2025-06-12 00:15:29',NULL,NULL,'2025-06-19 07:50:00');
...
INSERT INTO `content_block_history` VALUES (34,29,1,'TEXT','새 텍스트 블록','[]','admin','172.30.1.254','2025-07-18 18:05:24','admin','172.30.1.254','2025-07-18 18:05:24'),(35,30,1,'IMAGE','새 이미지 캡션','[]','admin','172.30.1.254','2025-07-18 18:05:46','admin','172.30.1.254','2025-07-18 18:05:46'),(36,31,1,'IMAGE','새 이미지 캡션','[]','admin','172.30.1.254','2025-07-18 18:05:58','admin','172.30.1.254','2025-07-18 18:05:58'),(37,32,1,'TEXT','새 텍스트 블록','[]','admin','172.30.1.254','2025-07-18 18:06:27','admin','172.30.1.254','2025-07-18 18:06:27'),(38,33,1,'IMAGE','새 이미지 캡션','[]','admin','172.30.1.254','2025-07-18 18:06:44','admin','172.30.1.254','2025-07-18 18:06:44'),(40,35,1,'TEXT','새 텍스트 블록','[]','admin','172.30.1.254','2025-07-18 18:07:25','admin','172.30.1.254','2025-07-18 18:07:25'),(41,33,2,'IMAGE','새 이미지 캡션','[562]','admin','172.30.1.254','2025-07-18 18:07:42','admin','172.30.1.254','2025-07-18 18:07:42'),(42,36,1,'IMAGE','새 이미지 캡션','[]','admin','172.30.1.254','2025-07-18 18:07:57','admin','172.30.1.254','2025-07-18 18:07:57');
...
INSERT INTO `content_blocks` VALUES (29,NULL,'TEXT','광안리 · 해운대 · 센텀시티를 잇는 이상적인 허브',NULL,0,2,'admin','172.30.1.254','2025-07-18 18:05:15','admin','172.30.1.254','2025-07-18 18:05:24'),(30,NULL,'IMAGE','메인 헤더',NULL,1,2,'admin','172.30.1.254','2025-07-18 18:05:26','admin','172.30.1.254','2025-07-18 18:05:46'),(31,NULL,'IMAGE','새 이미지 캡션',NULL,2,2,'admin','172.30.1.254','2025-07-18 18:05:50','admin','172.30.1.254','2025-07-18 18:05:58'),(32,NULL,'TEXT','도심 속 합리적인 컨벤션 & 스테이',NULL,3,2,'admin','172.30.1.254','2025-07-18 18:06:08','admin','172.30.1.254','2025-07-18 18:07:15'),(33,NULL,'IMAGE','새 이미지 캡션',NULL,5,3,'admin','172.30.1.254','2025-07-18 18:06:32','admin','172.30.1.254','2025-07-18 18:07:42'),(35,NULL,'TEXT','Busan Youth Hostel Arpina Busan Youth Hostel Arpina',NULL,4,2,'admin','172.30.1.254','2025-07-18 18:07:11','admin','172.30.1.254','2025-07-18 18:07:25'),(36,NULL,'IMAGE','새 이미지 캡션',NULL,6,2,'admin','172.30.1.254','2025-07-18 18:07:50','admin','172.30.1.254','2025-07-18 18:07:57');
...
CREATE TABLE `file` (
  ...
  KEY `idx_file_order` (`menu`,`menu_id`,`file_order`),
  KEY `idx_file_public_menu` (`menu`,`menu_id`,`public_yn`),
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`handy`@`%`*/ /*!50003 TRIGGER trg_file_public_yn_check_insert BEFORE INSERT ON file
FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'IGNORE_SPACE,STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`handy`@`%`*/ /*!50003 TRIGGER trg_file_order_check_insert BEFORE INSERT ON file
FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'IGNORE_SPACE,STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`handy`@`%`*/ /*!50003 TRIGGER trg_file_public_yn_check_update BEFORE UPDATE ON file
FOR EACH ROW
BEGIN
    IF NEW.public_yn NOT IN ('Y', 'N') THEN
        SIGNAL SQLSTATE '45000'
...
/*!50003 SET sql_mode              = 'IGNORE_SPACE,STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`handy`@`%`*/ /*!50003 TRIGGER trg_file_order_check_update BEFORE UPDATE ON file
FOR EACH ROW
BEGIN
    IF NEW.file_order < 0 THEN
        SIGNAL SQLSTATE '45000'
...
INSERT INTO `groups` VALUES ('00000000-0000-0000-0000-000000000000','Default Group','System default group',NULL,NULL,'2025-06-03 03:02:14',NULL,NULL,'2025-06-03 03:02:14');
...
INSERT INTO `menu` VALUES (51,'알림','FOLDER','/bbs/notices',NULL,'HEADER',1,7,NULL,NULL,NULL,'2025-05-14 21:53:24',NULL,NULL,'2025-07-11 08:38:07'),(79,'공지사항','BOARD','/bbs/notices',1,'HEADER',1,0,51,NULL,NULL,'2025-05-14 22:15:22',NULL,NULL,'2025-06-12 01:03:48'),(80,'갤러리','BOARD','/bbs/gallery',6,'HEADER',1,0,51,NULL,NULL,'2025-05-14 22:16:05',NULL,NULL,'2025-07-07 06:12:13'),(81,'자료실','BOARD','/bbs/resources',5,'HEADER',1,0,51,NULL,NULL,'2025-05-14 22:16:26',NULL,NULL,'2025-06-12 01:04:09'),(82,'자주 묻는 질문','BOARD','/bbs/faq',2,'HEADER',1,0,51,NULL,NULL,'2025-05-14 22:16:52',NULL,NULL,'2025-06-12 01:04:17'),(83,'고객의 소리','LINK','https://www.bmc.busan.kr/bmc/contents.do?mId=0304000000',3,'HEADER',1,0,51,NULL,NULL,'2025-05-14 22:17:10',NULL,NULL,'2025-07-21 02:09:58');
...
CREATE TABLE `schedule` (
  ...
  KEY `idx_schedule_time_range` (`start_date_time`,`end_date_time`) COMMENT '시간 범위 검색 인덱스'
...
/*!50003 SET sql_mode              = 'IGNORE_SPACE,STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`handy`@`%`*/ /*!50003 TRIGGER trg_schedule_time_check
...
/*!50003 SET sql_mode              = 'IGNORE_SPACE,STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`handy`@`%`*/ /*!50003 TRIGGER trg_schedule_time_check_update
...
INSERT INTO `template` VALUES (1,'기본 메인 템플릿','MAIN',1,1,NULL,NULL,'2025-04-27 23:02:22',NULL,NULL,'2025-04-27 23:02:22',0,NULL,''),(2,'기본 서브 템플릿','SUB',1,1,NULL,NULL,'2025-04-27 23:02:24',NULL,NULL,'2025-04-27 23:02:24',0,NULL,'');
...
INSERT INTO `template_type` VALUES ('MAIN','메인 템플릿','사이트의 메인 페이지에 사용되는 템플릿',NULL,NULL,'2025-04-27 23:02:20',NULL,NULL,'2025-04-27 23:02:20'),('NORMAL','일반 템플릿','일반 페이지에 사용되는 템플릿',NULL,NULL,'2025-04-27 23:02:20',NULL,NULL,'2025-04-27 23:02:20'),('SUB','서브 템플릿','서브 페이지에 사용되는 템플릿',NULL,NULL,'2025-04-27 23:02:20',NULL,NULL,'2025-04-27 23:02:20');
...
INSERT INTO `user` VALUES ('00008ee4-3c4f-48b3-a30f-f686fdddb51c','admin','admin','admin@ex.co.kr','$2a$10$ifHo7stsn6Bmb4E9XNvNw.DorLb9BoR/wfSspOknFGwmbmqR/94G6','ADMIN','','ACTIVE',NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,'2025-08-04 02:28:16',NULL,'2025-08-04 04:22:16','NULL',NULL,NULL,NULL);
