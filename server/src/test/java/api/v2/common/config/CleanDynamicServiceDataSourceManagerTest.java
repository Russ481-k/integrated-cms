...
class CleanDynamicServiceDataSourceManagerTest {
        ...
        void 환경변수_없는_서비스는_생성에_실패한다() {
                ...
                System.out.println(
                                "    \033[90m→\033[0m tryCreateServiceFromEnvironment(\033[36m\"" + unknownServiceId
                                                + "\"\033[0m)");
        ...
        void 서비스_데이터소스_목록을_조회할_수_있다() {
                ...
                allDataSources.keySet()
                                .forEach(serviceId -> System.out
                                                .println("      \033[90m-\033[0m \033[36m" + serviceId + "\033[0m"));
                System.out.println();
        }
        ...
        void 존재하지_않는_서비스_요청_시_기본_처리_동작을_확인한다() {
                ...
                System.out.println("    \033[90m→\033[0m getServiceDataSource(\033[36m\"" + nonExistentService
                                + "\"\033[0m)");
        ...
        void integrated_cms_서비스는_특별히_관리된다() {
                ...
                System.out.println("    \033[90m→\033[0m removeServiceDataSource(\033[35m\"" + integratedCmsId
                                + "\"\033[0m)");
