package api.v2.common.auth.provider;
...
class JwtTokenProviderTest {
        ...
        void 액세스_토큰이_올바르게_생성되고_검증된다() {
                ...
                System.out
                                .println("    \033[90m→\033[0m Token created: \033[36m" + accessToken.substring(0, 20)
                                                + "...\033[0m");
                ...
                System.out.println("    \033[32m✓\033[0m \033[90mAuthentication:\033[0m \033[32m" + auth.getName()
                                + "\033[0m");
        ...
        void 리프레시_토큰이_올바르게_생성되고_검증된다() {
                ...
                System.out
                                .println("    \033[90m→\033[0m Token created: \033[36m" + refreshToken.substring(0, 20)
                                                + "...\033[0m");
                ...
                // 리프레시 토큰의 클레임 검증
                Key key = new SecretKeySpec("testSecretKeyWithLength32BytesLong!".getBytes(StandardCharsets.UTF_8),
        ...
        void 만료된_토큰은_JwtException을_발생시킨다() {
                ...
                ReflectionTestUtils.setField(jwtTokenProvider, "accessTokenValidityInMilliseconds", -3600000L); // 1시간 전
                                                                                                                // 만료
                ...
                System.out
                                .println("    \033[90m→\033[0m Token created: \033[36m" + expiredToken.substring(0, 20)
                                                + "...\033[0m");
        ...
        void 다른_시크릿_키로_서명된_토큰은_JwtException을_발생시킨다() {
                ...
                System.out.println(
                                "    \033[90m→\033[0m Original token: \033[36m" + originalToken.substring(0, 20)
                                                + "...\033[0m");
        ...
        void 필수_클레임이_없는_토큰은_JwtException을_발생시킨다() {
                ...
                System.out.println(
                                "    \033[90m→\033[0m Token created: \033[36m" + tokenWithMissingClaims.substring(0, 20)
                                                + "...\033[0m");
