...
import api.v2.common.auth.domain.TokenRefreshHistory;
import api.v2.common.auth.repository.TokenRefreshHistoryRepository;
import api.v2.common.auth.service.impl.TokenRefreshHistoryServiceImpl;
...
class TokenRefreshHistoryServiceTest {
        ...
        void 토큰_갱신_이력을_기록한다() {
                ...
                System.out.println("    \033[90m→\033[0m Token ID: \033[36m" + testHistory.getRefreshTokenId()
                                + "\033[0m");
                ...
                System.out.println(
                                "    \033[32m✓\033[0m \033[90mUser ID:\033[0m \033[32m" + savedHistory.getUserId()
                                                + "\033[0m");
                System.out.println("    \033[32m✓\033[0m \033[90mToken ID:\033[0m \033[32m"
                                + savedHistory.getRefreshTokenId()
                                + "\033[0m");
        ...
        void 사용자의_활성_토큰_목록을_조회한다() {
                ...
                verify(historyRepository).findActiveTokensByUserId(eq(testHistory.getUserId()),
                                any(LocalDateTime.class));

                System.out.println(
                                "    \033[32m✓\033[0m \033[90mActive tokens found:\033[0m \033[32m" + result.size()
                                                + "\033[0m");
        ...
        void 갱신_횟수_제한을_확인한다() {
                ...
                System.out.println("    \033[32m✓\033[0m \033[90mRefresh count:\033[0m \033[32m" + maxRefreshes
                                + "\033[0m");
