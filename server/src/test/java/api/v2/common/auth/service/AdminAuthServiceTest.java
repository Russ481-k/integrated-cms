...
import api.v2.common.auth.service.impl.AdminAuthServiceImpl;
...
import api.v2.common.user.repository.AdminUserRepository;
...
class AdminAuthServiceTest {
        ...
        void 유효한_관리자_계정으로_로그인에_성공한다() {
                ...
                ResponseEntity<ApiResponseSchema<Map<String, Object>>> response = adminAuthService
        ...
        void 잘못된_비밀번호로_로그인하면_실패한다() {
                ...
                System.out
                                .println("    \033[32m✓\033[0m \033[90mError code:\033[0m \033[31m"
                                                + body.getErrorCode() + "\033[0m");
                System.out.println(
