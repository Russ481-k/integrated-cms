...
class CommonAuthServiceTest {
    ...
    void 통합_CMS_컨텍스트에서는_AdminAuthService를_사용한다() {
        ...
        ResponseEntity<ApiResponseSchema<Map<String, Object>>> mockResponse = 
                ResponseEntity.ok(ApiResponseSchema.success(responseData, "로그인이 성공적으로 완료되었습니다."));
        
        when(adminAuthService.loginUser(validLoginRequest)).thenReturn(mockResponse);
        
        System.out.println("    \033[90m→\033[0m Context type: \033[36m" + integratedContext.getServiceType() + "\033[0m");
        ...
        ResponseEntity<ApiResponseSchema<Map<String, Object>>> response = 
                commonAuthService.login(validLoginRequest, integratedContext);
        ...
        System.out.println("    \033[32m✓\033[0m \033[90mStatus code:\033[0m \033[32m" + response.getStatusCode() + "\033[0m");
        System.out.println("    \033[32m✓\033[0m \033[90mAdminAuthService used:\033[0m \033[32mconfirmed\033[0m");
        System.out.println("    \033[32m✓\033[0m \033[90mAuthService not used:\033[0m \033[32mconfirmed\033[0m\n");
    }
    ...
    void 서비스별_CMS_컨텍스트에서는_AuthService를_사용한다() {
        ...
        System.out.println("    \033[90m→\033[0m Context type: \033[36m" + serviceContext.getServiceType() + "\033[0m");
        System.out.println("    \033[90m→\033[0m Service ID: \033[36m" + serviceContext.getServiceId() + "\033[0m");
        System.out.println("    \033[90m→\033[0m Username: \033[36m" + validLoginRequest.getUsername() + "\033[0m");

        // When
        System.out.println("  \033[2m⚡ Action:\033[0m 서비스별 CMS 로그인 요청");
        ResponseEntity<ApiResponseSchema<Map<String, Object>>> response = 
                commonAuthService.login(validLoginRequest, serviceContext);
        System.out.println("    \033[90m→\033[0m login() 호출");
        ...
        System.out.println("    \033[32m✓\033[0m \033[90mAdminAuthService not used:\033[0m \033[32mconfirmed\033[0m\n");
    }
    ...
    void 로그인_실패_시_적절한_에러_응답을_반환한다() {
        ...
        System.out.println("    \033[32m✓\033[0m \033[90mStatus code:\033[0m \033[32m" + response.getStatusCode() + "\033[0m");
        System.out.println("    \033[32m✓\033[0m \033[90mError message:\033[0m \033[31m" + body.getMessage() + "\033[0m");
        System.out.println("    \033[32m✓\033[0m \033[90mError code:\033[0m \033[31m" + body.getErrorCode() + "\033[0m\n");
    }
    ...
    void 인증_컨텍스트를_올바르게_생성한다() {
        ...
        System.out.println("    \033[32m✓\033[0m \033[90mService type:\033[0m \033[32m" + context.getServiceType() + "\033[0m");
        System.out.println("    \033[32m✓\033[0m \033[90mService ID:\033[0m \033[32m" + context.getServiceId() + "\033[0m");
        System.out.println("    \033[32m✓\033[0m \033[90mClient IP:\033[0m \033[32m" + context.getClientIp() + "\033[0m");
        System.out.println("    \033[32m✓\033[0m \033[90mUser-Agent:\033[0m \033[32m" + context.getUserAgent() + "\033[0m");
