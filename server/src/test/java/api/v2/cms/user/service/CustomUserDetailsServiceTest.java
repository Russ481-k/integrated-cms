...
class CustomUserDetailsServiceTest {
        ...
        void 존재하는_사용자명으로_UserDetails를_로드한다() {
                ...
                System.out.println("    \033[32m✓\033[0m \033[90mUsername:\033[0m \033[32m" + userDetails.getUsername()
                                + "\033[0m");
        ...
        void 존재하지_않는_사용자명으로_조회하면_예외가_발생한다() {
                ...
                System.out.println("    \033[32m✓\033[0m \033[90mError message:\033[0m \033[31m"
