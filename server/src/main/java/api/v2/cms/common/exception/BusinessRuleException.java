...
public class BusinessRuleException extends CustomBaseException {
    ...
    public BusinessRuleException(ErrorCode errorCode) {
        super(errorCode.getDefaultMessage(), errorCode, HttpStatus.BAD_REQUEST); // Default to BAD_REQUEST for business
                                                                                 // rule violations
    }
    ...
    // Constructor to specify a different HttpStatus if needed (e.g., CONFLICT for
    // duplicate data)
