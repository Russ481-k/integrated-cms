package api.v2.cms.enterprise.service;
...
public interface EnterpriseService {
         ...
         */
        Page<EnterpriseDto> getAllEnterprises(Integer year, String name, String representative, String businessType,
                        Pageable pageable);
         ...
         * @return 생성된 기업 DTO
         * @throws api.v2.cms.common.exception.DuplicateResourceException 동일 연도에 동일 기업명
         *                                                                존재 시
         */
        EnterpriseDto createEnterprise(CreateEnterpriseRequest createRequest, MultipartFile imageFile, String createdBy,
                        String createdIp);
