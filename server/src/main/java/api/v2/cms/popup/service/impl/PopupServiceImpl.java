package api.v2.cms.popup.service.impl;
...
import api.v2.cms.popup.dto.AdminPopupRes;
import api.v2.cms.popup.dto.PopupDataReq;
import api.v2.cms.popup.dto.PopupDto;
import api.v2.cms.popup.dto.PopupRes;
import api.v2.cms.popup.repository.PopupRepository;
...
public class PopupServiceImpl implements PopupService {
    ...
    @Override
    @Transactional
    public PopupDto updatePopup(Long popupId, api.v2.cms.popup.dto.PopupUpdateReq popupUpdateReq, String contentJson,
    ...
    @Override
    @Transactional
    public void updateVisibility(Long popupId, api.v2.cms.popup.dto.PopupVisibilityReq req) {
        Popup popup = popupRepository.findById(popupId)
                .orElseThrow(() -> new EntityNotFoundException("Popup not found with id: " + popupId));
    ...
    @Override
    @Transactional
    public void updateOrder(api.v2.cms.popup.dto.PopupOrderReq req) {
