...
import api.v2.common.auth.security.JwtAuthenticationToken;
...
public class JwtTokenProvider {
    ...
    public Authentication getAuthentication(String token) {
        ...
        Collection<? extends GrantedAuthority> authorities = Collections
                .singletonList(new SimpleGrantedAuthority(roleStr));
        ...
        try {
            ...
            logger.error(
                    "[JwtTokenProvider] Failed to convert processed role string '{}' to UserRoleType enum. Error: {}",
                    processedRoleStr, e.getMessage());
            throw e;
        }
        ...
        logger.debug("Created UserDetails: {}, with gender: {}, name: '{}', email: '{}', phone: '{}'",
                principal, ((User) principal).getGender(), ((User) principal).getName(), ((User) principal).getEmail(),
                ((User) principal).getPhone());
