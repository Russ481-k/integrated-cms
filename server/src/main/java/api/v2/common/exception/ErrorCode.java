package api.v2.common.exception;
...
public enum ErrorCode {
    ...
    // v2 Service Context Errors (SC_xxxx)
    SERVICE_CONTEXT_NOT_SET("SC_0001", "서비스 컨텍스트가 설정되지 않았습니다.", HttpStatus.INTERNAL_SERVER_ERROR),
    INVALID_SERVICE_ID("SC_0002", "유효하지 않은 서비스 ID입니다.", HttpStatus.BAD_REQUEST),
    SERVICE_NOT_FOUND("SC_0003", "서비스를 찾을 수 없습니다.", HttpStatus.NOT_FOUND),
    DATABASE_CONNECTION_ERROR("SC_0004", "데이터베이스 연결에 실패했습니다.", HttpStatus.INTERNAL_SERVER_ERROR),

    // v2 Integrated CMS Errors (IC_xxxx)
    INSUFFICIENT_ADMIN_PERMISSION("IC_0001", "통합 관리 권한이 부족합니다.", HttpStatus.FORBIDDEN),
    SERVICE_CREATION_FAILED("IC_0002", "서비스 생성에 실패했습니다.", HttpStatus.INTERNAL_SERVER_ERROR),
    ADMIN_USER_NOT_FOUND("IC_0003", "관리자 사용자를 찾을 수 없습니다.", HttpStatus.NOT_FOUND),
    DUPLICATE_SERVICE_ID("IC_0004", "이미 존재하는 서비스 ID입니다.", HttpStatus.CONFLICT);
