package api.v2.common.exception.handler;
...
import api.v2.common.exception.DuplicateUsernameException;
import api.v2.common.exception.ErrorCode;
import api.v2.common.exception.NiceVerificationException;
import api.v2.common.template.exception.CannotDeleteFixedTemplateException;
import api.v2.common.template.exception.TemplateNotFoundException;
...
import api.v2.common.crud.exception.CrudValidationException;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
        ...
        @ExceptionHandler(CrudResourceNotFoundException.class)
        public ResponseEntity<ErrorResponse> handleCrudResourceNotFoundException(CrudResourceNotFoundException ex,
                        WebRequest request) {
                log.warn("CRUD Resource Not Found: {}. URI: {}", ex.getMessage(), request.getDescription(false));
                ErrorResponse errorResponse = new ErrorResponse(
                                ex.getHttpStatus().value(),
                                ex.getHttpStatus().getReasonPhrase(),
                                ex.getMessage(),
        ...
        @ExceptionHandler(CrudPermissionDeniedException.class)
        public ResponseEntity<ErrorResponse> handleCrudPermissionDeniedException(CrudPermissionDeniedException ex,
                        WebRequest request) {
                log.warn("CRUD Permission Denied: {}. URI: {}", ex.getMessage(), request.getDescription(false));
                ErrorResponse errorResponse = new ErrorResponse(
                                ex.getHttpStatus().value(),
                                ex.getHttpStatus().getReasonPhrase(),
                                ex.getMessage(),
        ...
        public ResponseEntity<ErrorResponse> handleCrudValidationException(CrudValidationException ex,
                        WebRequest request) {
                log.warn("CRUD Validation Failed: {}. URI: {}", ex.getMessage(), request.getDescription(false));
                ErrorResponse errorResponse = new ErrorResponse(
                                ex.getHttpStatus().value(),
                                ex.getHttpStatus().getReasonPhrase(),
                                ex.getMessage(),
        ...
        @ExceptionHandler(CrudBusinessRuleException.class)
        public ResponseEntity<ErrorResponse> handleCrudBusinessRuleException(CrudBusinessRuleException ex,
                        WebRequest request) {
                log.warn("CRUD Business Rule Violation: {}. URI: {}", ex.getMessage(), request.getDescription(false));
                ErrorResponse errorResponse = new ErrorResponse(
                                ex.getHttpStatus().value(),
                                ex.getHttpStatus().getReasonPhrase(),
                                ex.getMessage(),
