package api.v2.common.popup.service.impl;
...
import api.v2.common.popup.domain.Popup;
import api.v2.common.popup.dto.AdminPopupRes;
import api.v2.common.popup.dto.PopupDataReq;
import api.v2.common.popup.dto.PopupDto;
import api.v2.common.popup.dto.PopupRes;
import api.v2.common.popup.repository.PopupRepository;
import api.v2.common.popup.service.PopupService;
...
public class PopupServiceImpl implements PopupService {
    ...
    @Override
    @Transactional
    public PopupDto updatePopup(Long popupId, api.v2.common.popup.dto.PopupUpdateReq popupUpdateReq, String contentJson,
    ...
    @Override
    @Transactional
    public void updateVisibility(Long popupId, api.v2.common.popup.dto.PopupVisibilityReq req) {
        Popup popup = popupRepository.findById(popupId)
                .orElseThrow(() -> new EntityNotFoundException("Popup not found with id: " + popupId));
    ...
    @Override
    @Transactional
    public void updateOrder(api.v2.common.popup.dto.PopupOrderReq req) {
