package api.v2.common.template.domain;
...
public class Template {
    ...
    @Builder
    public Template(String templateName, String description, String layoutJson, boolean published, int versionNo,
    ...
    public static class TemplateBuilder {
        ...
        public TemplateBuilder(String templateName, String description, TemplateType type, boolean published,
                int versionNo, List<TemplateRow> rows, String layoutJson) {
            this.templateName = templateName;
            this.description = description;
            this.type = type;
            this.published = published;
        ...
        public TemplateBuilder(Long templateId, String templateName, String description, TemplateType type,
                boolean published, int versionNo, List<TemplateRow> rows, String layoutJson) {
    ...
    @Builder
    public Template(Long templateId, String templateName, String description, TemplateType type, boolean published,
            int versionNo, List<TemplateRow> rows, String layoutJson) {
        this.templateId = templateId;
        this.templateName = templateName;
        this.description = description;
