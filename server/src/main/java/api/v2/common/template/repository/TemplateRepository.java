package api.v2.common.template.repository;
...
public interface TemplateRepository extends JpaRepository<Template, Long> {
       ...
       Optional<Template> findByTemplateIdAndPublished(@Param("templateId") Long templateId,
       ...
       List<Template> findOldVersionsByTemplateName(@Param("templateName") String templateName,
