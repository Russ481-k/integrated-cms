package api.v2.common.template.service.impl;

import lombok.RequiredArgsConstructor;
import api.v2.common.dto.ApiResponseSchema;
import api.v2.common.template.domain.Template;
import api.v2.common.template.dto.TemplateDto;
import api.v2.common.template.exception.TemplateNotFoundException;
import api.v2.common.template.repository.TemplateRepository;
import api.v2.common.template.service.TemplateService;
...
public class TemplateServiceImpl implements TemplateService {
    ...
    public ApiResponseSchema<TemplateDto> cloneTemplate(Long templateId) {
        try {
            ...
            logger.debug("템플릿 복제 완료 - originalTemplateId: {}, cloneTemplateId: {}", templateId,
                    savedClone.getTemplateId());
