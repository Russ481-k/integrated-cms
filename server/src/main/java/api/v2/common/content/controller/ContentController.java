package api.v2.common.content.controller;
...
import api.v2.common.content.domain.ContentStatus;
import api.v2.common.content.dto.ContentDto;
import api.v2.common.content.service.ContentService;
...
public class ContentController {
        ...
        public ResponseEntity<ApiResponseSchema<Page<ContentDto>>> searchContents(
                ...
                return ResponseEntity
                                .ok(ApiResponseSchema.success(contentService.searchContents(keyword, pageable),
                                                "콘텐츠 검색이 완료되었습니다."));
        }
        ...
        public ResponseEntity<ApiResponseSchema<Page<ContentDto>>> getContentsByStatus(
                        ...
                        Pageable pageable) {
                return ResponseEntity.ok(ApiResponseSchema.success(contentService.getContentsByStatus(status, pageable),
                                "상태별 콘텐츠를 성공적으로 조회했습니다."));
        }
         ...
         * return
         * ResponseEntity.ok(ApiResponseSchema.success(contentService.createVersion(
         * contentId), "콘텐츠 버전이 성공적으로 생성되었습니다."));
         * }
         * 
         ...
         * 
         * @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "404",
         * description = "컨텐츠 또는 버전을 찾을 수 없음")
         * })
         * 
