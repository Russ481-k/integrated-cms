...
CREATE TABLE PERMISSIONS (
    ...
    PERMISSION_CATEGORY VARCHAR(50) COMMENT '권한 카테고리 (MENU, FUNCTION, DATA, SYSTEM)',
    RESOURCE_TYPE VARCHAR(50) COMMENT '리소스 타입 (board, content, menu, user 등)',
    ACTION_TYPE VARCHAR(50) COMMENT '액션 타입 (create, read, update, delete, publish 등)',
